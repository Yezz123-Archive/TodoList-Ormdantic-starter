...
@router.post('/todos', response_model=TodoItem, status_code=status.HTTP_201_CREATED, tags=["Todo List"])
...
@router.delete('/todos/{id}', status_code=status.HTTP_204_NO_CONTENT, tags=["Todo List"])
